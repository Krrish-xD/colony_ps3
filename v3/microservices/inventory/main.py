...
logger = logging.LoggerAdapter(logger, extra={"service": "inventory"})
...
@app.get("/")
async def root():
    logger.info("Handling root request for inventory")
    ...
    return {"service": "inventory", "downstreams": responses}
