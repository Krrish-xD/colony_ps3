...
logger = logging.LoggerAdapter(logger, extra={"service": "notification"})
...
@app.get("/")
async def root():
    logger.info("Handling root request for notification")
    ...
    return {"service": "notification", "downstreams": responses}
