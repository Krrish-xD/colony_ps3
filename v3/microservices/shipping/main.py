...
logger = logging.LoggerAdapter(logger, extra={"service": "shipping"})

app = FastAPI(title="shipping Service", version="3.0.0")
...
@app.get("/")
async def root():
    logger.info("Handling root request for shipping")
    simulate_latency_and_errors()
    
    # downstream simulation
    downstreams = ["inventory"]
    responses = []
    ...
    return {"service": "shipping", "downstreams": responses}
